...
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): ClientFeatureOverrides {
      ...
      val interceptorOptions = pigeonVar_list[8] as String?
      val claimCreationTimeoutDurationInMins = pigeonVar_list[9] as Long?
      val sessionNoActivityTimeoutDurationInMins = pigeonVar_list[10] as Long?
      val aiProviderNoActivityTimeoutDurationInSecs = pigeonVar_list[11] as Long?
      val pageLoadedCompletedDebounceTimeoutMs = pigeonVar_list[12] as Long?
      val potentialLoginTimeoutS = pigeonVar_list[13] as Long?
      val screenshotCaptureIntervalSeconds = pigeonVar_list[14] as Long?
      return ClientFeatureOverrides(cookiePersist, singleReclaimRequest, attestorBrowserRpcUrl, idleTimeThresholdForManualVerificationTrigger, sessionTimeoutForManualVerificationTrigger, isAIFlowEnabled, manualReviewMessage, loginPromptMessage, interceptorOptions, claimCreationTimeoutDurationInMins, sessionNoActivityTimeoutDurationInMins, aiProviderNoActivityTimeoutDurationInSecs, pageLoadedCompletedDebounceTimeoutMs, potentialLoginTimeoutS, screenshotCaptureIntervalSeconds)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
