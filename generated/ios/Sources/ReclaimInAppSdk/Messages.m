...
+ (instancetype)makeWithEnableLogHandler:(BOOL )enableLogHandler
  ...
  pigeonResult.canLogMetadata = canLogMetadata;
  return pigeonResult;
}
+ (ClientLogConsumerOverride *)fromList:(NSArray<id> *)list {
  ClientLogConsumerOverride *pigeonResult = [[ClientLogConsumerOverride alloc] init];
  ...
  pigeonResult.canLogMetadata = GetNullableObjectAtIndex(list, 4);
  return pigeonResult;
}
+ (nullable ClientLogConsumerOverride *)nullableFromList:(NSArray<id> *)list {
...
- (NSArray<id> *)toList {
  return @[
    ...
    self.canLogMetadata ?: [NSNull null],
  ];
}
- (BOOL)isEqual:(id)object {
  if (self == object) {
  ...
  return self.enableLogHandler == other.enableLogHandler && self.canSdkCollectTelemetry == other.canSdkCollectTelemetry && FLTPigeonDeepEquals(self.canSdkPrintLogs, other.canSdkPrintLogs) && FLTPigeonDeepEquals(self.logLevel, other.logLevel) && FLTPigeonDeepEquals(self.canLogMetadata, other.canLogMetadata);
}
...
- (NSUInteger)hash {
  ...
  result = result * 31 + FLTPigeonDeepHash(self.logLevel);
  result = result * 31 + FLTPigeonDeepHash(self.canLogMetadata);
  return result;
}
@end
