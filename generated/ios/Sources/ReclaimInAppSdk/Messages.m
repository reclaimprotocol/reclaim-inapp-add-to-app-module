...
+ (ClientFeatureOverrides *)fromList:(NSArray<id> *)list {
  ...
  pigeonResult.interceptorOptions = GetNullableObjectAtIndex(list, 8);
  pigeonResult.claimCreationTimeoutDurationInMins = GetNullableObjectAtIndex(list, 9);
  pigeonResult.sessionNoActivityTimeoutDurationInMins = GetNullableObjectAtIndex(list, 10);
  pigeonResult.aiProviderNoActivityTimeoutDurationInSecs = GetNullableObjectAtIndex(list, 11);
  pigeonResult.pageLoadedCompletedDebounceTimeoutMs = GetNullableObjectAtIndex(list, 12);
  pigeonResult.potentialLoginTimeoutS = GetNullableObjectAtIndex(list, 13);
  pigeonResult.screenshotCaptureIntervalSeconds = GetNullableObjectAtIndex(list, 14);
  return pigeonResult;
}
+ (nullable ClientFeatureOverrides *)nullableFromList:(NSArray<id> *)list {
