...
typedef NS_ENUM(NSUInteger, ReclaimSessionStatus) {
  ...
  ReclaimSessionStatusUSER_INTERACTED = 10,
  ReclaimSessionStatusUSER_TYPED = 11,
};
...
@property(nonatomic, copy, nullable) NSString * termsOfServiceUrl;
@property(nonatomic, copy, nullable) NSString * potentialFailureReasonsUrl;
@end
