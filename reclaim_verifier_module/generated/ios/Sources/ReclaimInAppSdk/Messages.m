...
+ (instancetype)makeWithAppId:(NSString *)appId
  ...
  pigeonResult.hideLanding = hideLanding;
...
+ (ReclaimApiVerificationRequest *)fromList:(NSArray<id> *)list {
  ...
  pigeonResult.hideLanding = [GetNullableObjectAtIndex(list, 8) boolValue];
  pigeonResult.autoSubmit = [GetNullableObjectAtIndex(list, 9) boolValue];
  pigeonResult.acceptAiProviders = [GetNullableObjectAtIndex(list, 10) boolValue];
  pigeonResult.webhookUrl = GetNullableObjectAtIndex(list, 11);
  return pigeonResult;
}
+ (nullable ReclaimApiVerificationRequest *)nullableFromList:(NSArray<id> *)list {
...
- (void)setOverridesProvider:(nullable ClientProviderInformationOverride *)arg_provider feature:(nullable ClientFeatureOverrides *)arg_feature logConsumer:(nullable ClientLogConsumerOverride *)arg_logConsumer sessionManagement:(nullable ClientReclaimSessionManagementOverride *)arg_sessionManagement appInfo:(nullable ClientReclaimAppInfoOverride *)arg_appInfo completion:(void (^)(FlutterError *_Nullable))completion {
  ...
  FlutterBasicMessageChannel *channel =
    [FlutterBasicMessageChannel
      ...
      binaryMessenger:self.binaryMessenger
      codec:nullGetMessagesCodec()];
  [channel sendMessage:@[arg_provider ?: [NSNull null], arg_feature ?: [NSNull null], arg_logConsumer ?: [NSNull null], arg_sessionManagement ?: [NSNull null], arg_appInfo ?: [NSNull null]] reply:^(NSArray<id> *reply) {
    if (reply != nil) {
      if (reply.count > 1) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        ...
        codec:nullGetMessagesCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(logSessionAppId:providerId:sessionId:logType:error:)], @"ReclaimApi api (%@) doesn't respond to @selector(logSessionAppId:providerId:sessionId:logType:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray<id> *args = message;
        NSString *arg_appId = GetNullableObjectAtIndex(args, 0);
        NSString *arg_providerId = GetNullableObjectAtIndex(args, 1);
        ...
        FlutterError *error;
        [api logSessionAppId:arg_appId providerId:arg_providerId sessionId:arg_sessionId logType:arg_logType error:&error];
        callback(wrapResult(nil, error));
      }];
    } else {
      [channel setMessageHandler:nil];
