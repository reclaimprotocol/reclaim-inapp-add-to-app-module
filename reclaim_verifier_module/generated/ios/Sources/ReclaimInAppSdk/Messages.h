...
@property(nonatomic, assign) BOOL  hideLanding;
...
- (void)setOverridesProvider:(nullable ClientProviderInformationOverride *)provider feature:(nullable ClientFeatureOverrides *)feature logConsumer:(nullable ClientLogConsumerOverride *)logConsumer sessionManagement:(nullable ClientReclaimSessionManagementOverride *)sessionManagement appInfo:(nullable ClientReclaimAppInfoOverride *)appInfo completion:(void (^)(FlutterError *_Nullable))completion;
...
- (void)createSessionAppId:(NSString *)appId providerId:(NSString *)providerId sessionId:(NSString *)sessionId completion:(void (^)(NSNumber *_Nullable, FlutterError *_Nullable))completion;
...
- (void)logSessionAppId:(NSString *)appId providerId:(NSString *)providerId sessionId:(NSString *)sessionId logType:(NSString *)logType error:(FlutterError *_Nullable *_Nonnull)error;
@end

extern void SetUpReclaimApi(id<FlutterBinaryMessenger> binaryMessenger, NSObject<ReclaimApi> *_Nullable api);

extern void SetUpReclaimApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<ReclaimApi> *_Nullable api, NSString *messageChannelSuffix);
