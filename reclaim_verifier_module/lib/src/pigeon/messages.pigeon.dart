  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      case 129:
        ...
        return value == null
            ? null
            : ReclaimApiVerificationExceptionType.values[value];
      case 130:
        final int? value = readValue(buffer) as int?;
      ...
      case 137:
        return ClientReclaimSessionManagementOverride.decode(
          readValue(buffer)!,
        );
      case 138:
        ...
        messageChannelSuffix.isNotEmpty ? '.$messageChannelSuffix' : '';
    {
      ...
      if (api == null) {
        ...
        pigeonVar_channel.setMessageHandler((Object? message) async {
          ...
          final ReclaimApiVerificationRequest? arg_request =
              (args[0] as ReclaimApiVerificationRequest?);
          assert(
            arg_request != null,
          ...
          try {
            final ReclaimApiVerificationResponse output = await api
                .startVerification(arg_request!);
    ...
    }
    {
      ...
      if (api == null) {
        ...
        pigeonVar_channel.setMessageHandler((Object? message) async {
          ...
          try {
            final ReclaimApiVerificationResponse output = await api
                .startVerificationFromUrl(arg_url!);
            return wrapResponse(result: output);
          } on PlatformException catch (e) {
            return wrapResponse(error: e);
          } catch (e) {
    ...
    }
    {
      ...
      if (api == null) {
        ...
        pigeonVar_channel.setMessageHandler((Object? message) async {
          ...
          final List<Object?> args = (message as List<Object?>?)!;
          final ClientProviderInformationOverride? arg_provider =
              (args[0] as ClientProviderInformationOverride?);
          final ClientFeatureOverrides? arg_feature =
              (args[1] as ClientFeatureOverrides?);
          final ClientLogConsumerOverride? arg_logConsumer =
              (args[2] as ClientLogConsumerOverride?);
          final ClientReclaimSessionManagementOverride? arg_sessionManagement =
              (args[3] as ClientReclaimSessionManagementOverride?);
          final ClientReclaimAppInfoOverride? arg_appInfo =
              (args[4] as ClientReclaimAppInfoOverride?);
...
class ReclaimApi {
  ...
  Future<bool> ping() async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.reclaim_verifier_module.ReclaimApi.ping$pigeonVar_messageChannelSuffix';
  ...
  Future<void> onLogs(String logJsonString) async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.reclaim_verifier_module.ReclaimApi.onLogs$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
          pigeonVar_channelName,
          pigeonChannelCodec,
  ...
  Future<bool> createSession({
    ...
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.reclaim_verifier_module.ReclaimApi.createSession$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
          pigeonVar_channelName,
          pigeonChannelCodec,
    ...
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(
      <Object?>[appId, providerId, sessionId],
    );
    final List<Object?>? pigeonVar_replyList =
        await pigeonVar_sendFuture as List<Object?>?;
    if (pigeonVar_replyList == null) {
  ...
  Future<bool> updateSession({
    ...
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.reclaim_verifier_module.ReclaimApi.updateSession$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
          pigeonVar_channelName,
          pigeonChannelCodec,
  ...
  Future<void> logSession({
    ...
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.reclaim_verifier_module.ReclaimApi.logSession$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
          pigeonVar_channelName,
          pigeonChannelCodec,
    ...
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(
      <Object?>[appId, providerId, sessionId, logType],
    );
    final List<Object?>? pigeonVar_replyList =
        await pigeonVar_sendFuture as List<Object?>?;
    if (pigeonVar_replyList == null) {
  ...
  Future<void> onSessionIdentityUpdate(
    ReclaimSessionIdentityUpdate? update,
  ) async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.reclaim_verifier_module.ReclaimApi.onSessionIdentityUpdate$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
          pigeonVar_channelName,
          pigeonChannelCodec,
  ...
  Future<Map<String, dynamic>> fetchProviderInformation({
    ...
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.reclaim_verifier_module.ReclaimApi.fetchProviderInformation$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
          pigeonVar_channelName,
          pigeonChannelCodec,
    ...
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(
      <Object?>[appId, providerId, sessionId, signature, timestamp],
    );
    final List<Object?>? pigeonVar_replyList =
        await pigeonVar_sendFuture as List<Object?>?;
    if (pigeonVar_replyList == null) {
