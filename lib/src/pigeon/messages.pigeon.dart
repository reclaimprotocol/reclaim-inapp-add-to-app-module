...
class ClientFeatureOverrides {
  ...
  static ClientFeatureOverrides decode(Object result) {
    ...
    return ClientFeatureOverrides(
      ...
      interceptorOptions: result[8] as String?,
      claimCreationTimeoutDurationInMins: result[9] as int?,
      sessionNoActivityTimeoutDurationInMins: result[10] as int?,
      aiProviderNoActivityTimeoutDurationInSecs: result[11] as int?,
      pageLoadedCompletedDebounceTimeoutMs: result[12] as int?,
      potentialLoginTimeoutS: result[13] as int?,
      screenshotCaptureIntervalSeconds: result[14] as int?,
    );
  }
