...
ReclaimUrlRequest _$ReclaimUrlRequestFromJson(Map<String, dynamic> json) => ReclaimUrlRequest(
...
Map<String, dynamic> _$ReclaimUrlRequestToJson(ReclaimUrlRequest instance) => <String, dynamic>{
  ...
  'acceptAiProviders': instance.acceptAiProviders,
